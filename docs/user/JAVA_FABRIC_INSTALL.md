...
```text
Java 版启动 Minecraft 1.21.8 起的 1.21.x 版本
打开已有单人存档
开放到局域网
别人加入你的局域网世界
```
...
- Java 版
- Minecraft 1.21.8 起的 1.21.x 版本
- 对应游戏版本的 Fabric Loader
- 对应游戏版本的 Fabric API
- 本项目的 controller
- 本项目构建出来的 `blockwright-fabric-*.jar`
...
如果你在 Java 版里给当前 1.21.x 游戏版本单独设置了游戏目录，就放到那个目录下的：
...
当前 Fabric 模组按 Minecraft 1.21.8 构建，模组元数据允许 1.21.8 起的 1.21.x 版本。1.22 及后续大版本不要默认当成兼容，需要单独构建和测试。
